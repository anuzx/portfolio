    ...
    const down = (e: KeyboardEvent) => {
      ...
      if (e.shiftKey) {
        ...
        // Links
          ...
          e.preventDefault();
          runCommand(() => openExternal("https://x.com/0xzdev"));
        } else if (key === "l") {
          e.preventDefault();
          runCommand(() =>
            openExternal("https://www.linkedin.com/in/anuj-parasar-0a905b360/"),
          );
        } else if (key === "g") {
          e.preventDefault();
          runCommand(() => openExternal("https://github.com/anuzx"));
        } else if (key === "e") {
          e.preventDefault();
        ...
        <CommandList className="font-custom2 p-2">
          ...
          <CommandGroup heading="Links">
            <CommandItem
              ...
              className="rounded-lg py-3"
            >
              <FaXTwitter className="mr-2 h-4 w-4 text-neutral-500" />
              <span>X Profile</span>
              <CommandShortcut className="rounded border border-neutral-200 bg-neutral-100 px-1.5 py-0.5 font-mono text-[10px] dark:border-neutral-700 dark:bg-neutral-800">
                shift + X
              </CommandShortcut>
            ...
            <CommandItem
              ...
              className="rounded-lg py-3"
            >
              <FaLinkedin className="mr-2 h-4 w-4 text-neutral-500" />
