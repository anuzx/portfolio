...
const posts = [
  {
    ...
    description:
      "Scalability, queues, event-driven systems and backend architecture.",
    date: "2026-05-10",
    url: "https://medium.com/@yourusername/distributed-systems",
  },
  {
    title: "Building AI Apps with LangChain",
    description:
      "RAG pipelines, embeddings and production AI workflows.",
    date: "2026-04-22",
    url: "https://medium.com/@yourusername/langchain-ai-apps",
  },
  {
    title: "Scaling Next.js Applications",
    description:
      "Architecture decisions, optimization techniques, and production deployment patterns.",
    date: "2026-03-15",
    url: "https://medium.com/@yourusername/scaling-nextjs",
  },
];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-3">
          ...
          <p className="text-s text-neutral-600 dark:text-neutral-400 leading-relaxed mt-1 tracking-tight font-custom2 max-w-xl">
            I write about software engineering, scalable systems, AI,
            backend architecture, and modern web development.
          </p>
        </div>
